    ...
    <div className="p-4 max-w-3xl mx-auto">
      ...
      <Tabs defaultValue="portfolio" className="w-full">
        ...
        <TabsContent value="portfolio">
          ...
          {/* Display User Assets */}
          <UserAssets tokens={sortedTokens} />
        </TabsContent>
        ...
        <div className="fixed inset-0 bg-background/50 flex justify-center items-end z-50">
          <div ref={filterRef} className="rounded-t-xl bg-background w-full max-w-md p-6 shadow-lg">
            ...
            {['balance', 'price'].map((criteria) => (
              <button
                key={criteria}
                className={`w-full text-left text-lg py-3 px-5 mb-2 flex items-center justify-between rounded-lg ${sortCriteria === criteria ? 'bg-blue-200 p-2 dark:bg-primary/10' : ''
                  }`}
                onClick={() => {
