...
import {BitLST} from "../contracts/BitLST.sol";
...
contract RegisterApp is Script {
    ...
    function setUp() public {
        ...
        if (block.chainid == 31337) {
            ...
            string memory lstRoot = vm.readFile(
                "script/anvil-testnet/lst-addresses.json"
            );
            ...
            _APP_ADDRESS = stdJson.readAddress(lstRoot, "$.BitLST");
        } else {
            ...
            _APP_ADDRESS = 0x58C3a95F687B9C707C4d36a57EF680D765D28d45; // replace with your BitLST address
        }
    }
    function run() external {
        ...
        if (BitLST(_APP_ADDRESS).owner() != deployer) {
